...
options:
    ...
    host_type_index:
        description:
            - The index that maps to host type you wish to create. It is recommended to use the M(na_eseries_facts) module to gather this information. Alternatively you can use the WSP portal to retrieve the information.
        required: True
    ports:
        description:

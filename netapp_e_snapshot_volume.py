...
DOCUMENTATION = """
---
module: na_eseries_snapshot_volume
...
options:
    ...
    snapshot_image_id:
      ...
      description: 
          ...
          - "Note: You'll likely want to use the M(na_eseries_facts) module to find the ID of the image you want."
    full_threshold:
      description:

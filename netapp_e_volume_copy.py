    ...
    if response_code == 200:
        ...
        for volume in candidates:
            if volume['capacity'] > source_capacity:
                if volume['volumeCopyTarget'] == False:
                    if volume['volumeCopySource'] == False:
...
def main():
    ...
    if params['search_volume_id'] != None:
    ...
    if params['status'] == 'present':
        ...
        if params['volume_copy_pair_id'] == None:
